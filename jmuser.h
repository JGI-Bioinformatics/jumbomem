/*---------------------------------------------------------------
 * JumboMem memory server: Provide access to JumboMem internals
 *
...
extern void *jmu_malloc(size_t numbytes);

/* Invoke realloc() as if it were called internally by JumboMem. */
extern void *jmu_realloc(void *ptr, size_t numbytes);

/* Invoke free() as if it were called internally by JumboMem. */
extern void jmu_free(void *ptr);
